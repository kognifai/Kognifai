...
The Development Stack SDK is a complete package that takes care of installing and configuring the PoseidonNext framework and Galore packages. Access the [Dev Stack SDK](https://github.com/kognifai/Galore/blob/master/SDK-documentation/readme.md) to install and configure packages, to build your own applications using Galore. 
